                  ...
                  <!-- Bootstrap tabs. -->
                      <div class="tabbable tabs-left">
                          ...
                          <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="#tab1" data-toggle="tab">课程1</a></li>
                            <li><a href="#tab2" data-toggle="tab">课程2</a></li>                            
                          </ul>
                          <!-- Tab content -->
                          <div class="tab-content">
                           ...
                           <!-- In "id", use the value which you used in above anchor tags -->
                            <div class="tab-pane active" id="tab1">
                              ...
                              <h5>课程1</h5>
                              <p>课程公告</p>
							  <a href="#" class="btn btn-danger">修改课程公告</a>
                              <ul>
                                 <li>课件1</li>
                                 <li>课件2</li>
                                 <li>课件3</li>
                              ...
                              <a href="#" class="btn btn-danger">上传课件</a>      <a href="#" class="btn btn-danger">删除课件</a>
                            </div>
