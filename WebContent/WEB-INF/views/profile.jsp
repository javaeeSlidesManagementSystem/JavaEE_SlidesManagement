          ...
          <hr />
                            <div class="form">
                                      ...
                                      <form class="form-horizontal">
                                          <!-- Name -->
                                          <div class="control-group">
                                            <label class="control-label" for="name1">姓名</label>
                                            <div class="controls">
                                              <input type="text" class="input-xlarge" id="name1">
                                            </div>
                                          </div>   
                                          <!-- Email -->
                                          <div class="control-group">
                                            <label class="control-label" for="email1">邮箱</label>
                                            <div class="controls">
                                              <input type="text" class="input-xlarge" id="email1">
                                            </div>
                                          </div>
                                          <!-- Telephone -->
                                          <div class="control-group">
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                              <input type="text" class="input-xlarge" id="username2">
                                            </div>
                                          </div>
                                          <!-- Password -->
                                          <div class="control-group">
